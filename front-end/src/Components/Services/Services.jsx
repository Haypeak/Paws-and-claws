    ...
    return (
        <div className='services'>
            <div className='services-left'>
                ...
                <p>We love animals and strive to make every visit a positive experience. Our friendly staff is always ready to offer advice and support, ensuring your pets get the best attention. Visit Paws and Claws Pet Shop and experience our commitment to your pet&#39;s well-being!  <button className='bb' onClick={() => navigate('/VeterinaryService')}>Discover more <img src={icon} alt='' className='icon'/></button></p>
